...
| | [JAX](https://github.com/jax-ml/jax) (CPU) | ✗ | ✗ | ✗ | ✗ | |
| NVIDIA GeForce RTX 5080 | [PyTorch 2.11.0+cu130](https://github.com/pytorch/pytorch/releases/tag/v2.11.0) (CUDA 13.0) | 6.11 | **1** | **1** | **2** | 0.57 |
| | [Candle](https://github.com/huggingface/candle/tree/6b4d8a1) (CPU) | ~~0.00~~ | ~~3344~~ | ~~—~~ | ~~—~~ | ~~0.00~~ |
| | [Burn](https://github.com/tracel-ai/burn) (wgpu) | — | — | — | — | |
| | [Luminal](https://github.com/luminal-ai/luminal) (CPU) | — | — | — | — | |
| | [Meganeura](https://github.com/kvark/meganeura/tree/5ddf5e5) (Vulkan) | **1.42** | 3 | 3 | 5 | 0.57 |
| | [GGML](https://github.com/ggerganov/ggml) (CPU) | — | — | — | — | |
| | [ONNX Runtime](https://github.com/microsoft/onnxruntime) (CPUExecutionProvider) | ~~0.58~~ | ~~4~~ | ~~—~~ | ~~—~~ | ~~0.05~~ |
| | [JAX](https://github.com/jax-ml/jax) (CPU) | ✗ | ✗ | ✗ | ✗ | |
